...
console.log(
    `A triangle with the longest side of ${triangleLongestSide} and height of ${triangleHeight}`);
...
const areaOfTriangle2 = triangleArea2(triangleHeight2);
console.log('We are missing one of the values, so it defaults to 0');
console.log(`Has an area of ${areaOfTriangle2}`);
console.log('--------------------------------------------');

const areaOfTriangle3 = triangleArea2(12, 10);
console.log(`Has an area of ${areaOfTriangle3}`);
console.log('--------------------------------------------');
